...
API_KEY = 'XYZXYXXYXXYZXYZXYZXYZXYZXYZXYZ'
"""
   You must include an API key with every Geocoding API request.
   To get an API Key you have to go to this webpage https://cloud.google.com/maps-platform/#get-started 
   and pick the products you need. Also select or create a project and finally you have to set up a billing account. 
...
if __name__ == '__main__':
    ...
    address_to_search = ['129 Harish Reddy Building, Bangalore 560035']
    data = []
